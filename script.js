                        ...
                        <div style="display:flex;justify-content:space-between;align-items:flex-start">
                            <div style="flex:1">
                                <div style="font-weight:600;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
                                    ...
                                    ${modeBadge}
                                    <button class="btn-fav" data-id="${c.id}" style="background:none;border:none;cursor:pointer;color:${c.is_favorite ? '#e11d48' : '#567a60'};padding:4px;display:flex;align-items:center;justify-content:center">${heart}</button>
                                </div>
    ...
    bindHistoryBtns() {
        document.querySelectorAll('.btn-fav').forEach(btn => {
            btn.addEventListener('click', async (e) => {
                ...
                target.style.color = newStatus ? '#e11d48' : '#567a60';
            });
        });
